...
if (process.env.NODE_ENV === 'production') {
    ...
    const corsOptions = {
        origin: ['http://10.0.0.190:8080', 'http://127.0.0.1:8080', 'http://localhost:8080', 'http://127.0.0.1:3000', 'http://localhost:3000'],
        credentials: true,
    }
...
// const port = process.env.PORT || '10.0.0.190:3030'
app.listen(port, () => {
    logger.info('Server is running on port: ' + port)
})

console.log('SERVER.JS , backend is RUNNING')
